...
export const translations = {
  en: {
    ...
    checkout: {
      ...
      pendingBody: "Complete the payment in your payment window. This page checks the status automatically.",
      ...
      stillWaiting: "Bitcoin network confirmations can take a while. This page keeps checking every 30 seconds.",
    ...
    products: {
      ...
      instant: {
        ...
        checkoutBody: 'Your bundle unlocks automatically after payment confirmation.',
  ...
  es: {
    ...
    checkout: {
      ...
      pendingBody: "Completa el pago en la ventana de pago. Esta página comprueba el estado automáticamente.",
      ...
      stillWaiting: "Las confirmaciones de la red Bitcoin pueden tardar. Esta página sigue comprobando el estado cada 30 segundos.",
      refundedTitle: 'Pago reembolsado',
      refundedBody: 'Este pago ya no puede desbloquear la descarga.',
      fulfillmentTitle: 'Datos de envío',
      fulfillmentBody: 'Introduce los datos de envío del artículo físico. Se envían al vendedor y este sitio no los guarda.',
      fulfillmentReceived: 'Datos de envío recibidos. El artículo físico ya puede prepararse para el envío.',
      fulfillmentSubmit: 'ENVIAR DATOS DE ENVÍO',
      fulfillmentSubmitting: 'Enviando datos de envío...',
      fulfillmentSubmittingHint: 'Enviando tus datos de forma segura al vendedor. Mantén esta pestaña abierta.',
      fulfillmentRetry: 'Tus datos no se enviaron. Revisa los campos e inténtalo de nuevo.',
      emailLabel: 'Email',
    ...
    products: {
      ...
      chooseFormatSecondary: 'VER EDICIONES FÍSICAS',
      ...
      pricePreview: {
        ...
        physicalShipping: 'Los productos físicos pueden sumar gastos de envío.',
        launchDiscount: 'Oferta de lanzamiento: {percent}% de descuento para los próximos {remaining} compradores.',
      },
      instant: {
        ...
        checkoutBody: 'Tu bundle se desbloquea automáticamente tras confirmar el pago.',
      ...
      collectors: {
        ...
        buyAtCopiaro: 'COMPRAR EDICIÓN COLECCIONISTA EN COPIARO',
      },
      // Digital Edition
      digital: {
      ...
      graded: {
        ...
        shippingWorld: 'Envío mundial',
        shippingWorldHint: 'Suma 12,49 EUR al total de la factura.',
        privacyNotice: 'Después del pago, esta página pide email y dirección de envío. Son necesarios para enviar el slab, se mandan al vendedor y el sitio no los guarda.',
      ...
      magazine: {
        ...
        checkoutTitle: 'Checkout directo Bitcoin + Lightning',
        checkoutBody: 'Elige el envío antes del pago. Una sola factura incluye el bundle de revista, el juego digital y el envío.',
        shippingEu: 'Envío UE',
        shippingEuHint: 'Suma 7,49 EUR al total de la factura.',
        shippingWorld: 'Envío mundial',
        shippingWorldHint: 'Suma 12,49 EUR al total de la factura.',
    ...
    contact: {
      ...
      proofBody: 'Tu navegador resuelve una pequeña prueba Hero of Bitcoin antes de enviar. Sin captcha externo, sin rastreo.',
      sending: 'ENVIANDO...',
  ...
  de: {
    ...
    checkout: {
      ...
      pendingBody: "Schließe die Zahlung im Zahlungsfenster ab. Diese Seite prüft den Status automatisch.",
      ...
      stillWaiting: "Bestätigungen im Bitcoin-Netzwerk können etwas dauern. Diese Seite prüft den Status weiter alle 30 Sekunden.",
    ...
    products: {
      ...
      pricePreview: {
        ...
        launchDiscount: 'Launch-Angebot: {percent}% Rabatt für die nächsten {remaining} Käufer.',
      },
      instant: {
        ...
        checkoutTitle: 'Bitcoin + Lightning Checkout',
        checkoutBody: 'Dein Bundle wird nach der Zahlungsbestätigung automatisch freigeschaltet.',
    ...
    contact: {
      ...
      proofBody: 'Dein Browser löst vor dem Senden einen kleinen Hero of Bitcoin Proof. Kein externer Captcha-Dienst, kein Tracking.',
      sending: 'SENDET...',
