...
export const translations = {
  ...
  es: {
    ...
    hero: {
      ...
      instantBody: 'Paga con Bitcoin o Lightning y desbloquea el bundle ROM + PDF justo despues del pago.',
    ...
    products: {
      ...
      instant: {
        ...
        quote: 'La forma mas rapida de comprar y jugar con Bitcoin o Lightning.',
        feature1: 'ROM + guia en PDF',
        ...
        checkoutBody: 'Tu bundle se desbloquea automaticamente tras la confirmacion del pago.',
  ...
  de: {
    ...
    products: {
      ...
      instant: {
        ...
        checkoutTitle: 'Bitcoin + Lightning Checkout',
        checkoutBody: 'Dein Bundle wird nach der Zahlungsbestatigung automatisch freigeschaltet.',
